...
# vold daily volumes 
vold <- spread_no_na[, c("sdate","Volume_EFFR", "Volume_OBFR", "Volume_TGCR", "Volume_BGCR", "Volume_SOFR" )]
head(vold)
str(vold)
...
meltrrbp <- melt(rrbp,id="sdate")
 rates <- ggplot(meltrrbp,aes(x=sdate,y=value,colour=variable,group=variable)) + 
  ...
  guides(shape = guide_legend(title = "Rate"))
   print(rates)
 ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/dailyratesdot2.pdf")
 ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/dailyratesdot2.png")
...
quantilesE<-spread_no_na[,c("EFFR","Volume_EFFR","TargetUe_EFFR","TargetDe_EFFR","Percentile01_EFFR","Percentile25_EFFR","Percentile75_EFFR","Percentile99_EFFR","sdate")]
...
quantilesS<-spread_no_na[, c("sdate","SOFR","Volume_SOFR","Percentile01_SOFR","Percentile25_SOFR","Percentile75_SOFR","Percentile99_SOFR")]

#quantilesE <- spread_no_na["EFFR","Volume_EFFR","TargetUe_EFFR","TargetDe_EFFR","Percentile01_EFFR","Percentile25_EFFR","Percentile75_EFFR","Percentile99_EFFR","sdate"]
#subset_df <- select(original_df, Column1, Column2, Column3)
quantilesE2<-select(spread_no_na,EFFR,Volume_EFFR,TargetUe_EFFR,TargetDe_EFFR,Percentile01_EFFR,Percentile25_EFFR,Percentile75_EFFR,Percentile99_EFFR,sdate)

library(dplyr)
quantilesE2 <- spread_no_na %>%
  mutate(sdate = as.Date(sdate))

quantilesE2 <- select(quantilesE2, sdate, EFFR, TargetUe_EFFR, TargetDe_EFFR, Percentile01_EFFR, Percentile25_EFFR, Percentile75_EFFR, Percentile99_EFFR)

# Check the structure of the new dataframe
str(quantilesE2)

# Assuming 'spread_no_na' is your original dataframe
quantilesE2 <- spread_no_na %>%
  mutate(sdate = as.Date(sdate)) %>%
  select(sdate, EFFR, TargetUe_EFFR, TargetDe_EFFR, Percentile01_EFFR, Percentile25_EFFR, Percentile75_EFFR, Percentile99_EFFR)
...
my_episodes <- new.env()
# Store your data frame in the environment
my_episodes$melteffr <-melteffr
# Save the environment to an RDS file
saveRDS(my_episodes, file = "C:/Users/Owner/Documents/Research/MonetaryPolicy/MPResults/LaTeX/my_environmentepisodes.RDS")
...
rates_norm <- ggplot(meltrates_norm,aes(x=sdate,y=value,colour=variable,group=variable)) + 
  ...
  theme_minimal()+ guides(shape = guide_legend(title = "Rate"))
print(rates_norm)
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_norm.pdf")
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_norm.png")
...
rates_adjust <- ggplot(meltrates_adjust,aes(x=sdate,y=value,colour=variable,group=variable)) + 
  ...
  scale_y_continuous(breaks = seq(150, 275, by = 25), limits = c(150, 275)) + 
  theme_minimal() + guides(shape = guide_legend(title = "Rate"))
print(rates_adjust)
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_adjust.pdf")
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_adjust.png")
...
rates_covid <- ggplot(meltrates_covid,aes(x=sdate,y=value,colour=variable,group=variable)) + 
  ...
  theme_minimal() + guides(shape = guide_legend(title = "Rate"))
print(rates_covid)
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_covid.pdf")
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_covid.png")
...
rates_zlb <- ggplot(meltrates_zlb,aes(x=sdate,y=value,colour=variable,group=variable)) + 
  ...
  theme_minimal() + guides(shape = guide_legend(title = "Rate"))
print(rates_zlb)
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_zlb.pdf")
ggsave("C:/Users/Owner/Documents/Research/MonetaryPolicy/Figures/Figures2/rates_zlb.png")
...
selected_columnsE <- Estats[c("EFFR","VolumeEFFR","PercentileE1", "PercentileE25","PercentileE75","PercentileE99")]
sampleschar <- data.frame(selected_columnsE,Ostats,Tstats,Bstats,Sstats)
samplechar2 <- xtable(sampleschar)
print(samplechar2)
# Sample data
categories = c('EFFR', 'OBFR', 'TGCR', 'BBGCR', 'SOFR')
