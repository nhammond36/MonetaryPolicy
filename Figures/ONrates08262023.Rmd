...
stats_norm<-data.frame(mean_norm,median_norm,var_norm, kurtosis_norm,skew_norm,cv_norm)
...
stats_adjust<-data.frame(mean_adjust,median_adjust,var_adjust, kurtosis_adjust,skew_adjust,cv_adjust)
...
stats_covid<-data.frame(mean_covid,median_covid,var_covid, kurtosis_covid,skew_covid,cv_covid)
...
stats_zlb<-data.frame(mean_zlb,median_zlb,var_zlb, kurtosis_zlb,skew_zlb,cv_zlb)
...
stats_inflation<-data.frame(mean_inflation,median_inflation,var_inflation, kurtosis_inflation,skew_inflation,cv_inflation)
moments_inflationt<-xtable(stats_inflation)            
str(stats_inflation)
```

rrbp
     mean_rrbp median_rrbp var_rrbp kurtosis      p.value  skewness p.value.1   cv_rrbp
EFFR  108.3327          91 9634.837        1 2.832104e-17 -18.50948         0 0.9060714
OBFR  104.8129          81 9870.496        1 2.832104e-17 -18.50948         0 0.9478834
TGCR  104.4386          79 9730.003        1 2.832104e-17 -18.50948         0 0.9444859
BGCR  105.5754          80 9734.641        1 2.832104e-17 -18.50948         0 0.9345382
SOFR  108.1339          91 9716.111        1 2.832104e-17 -18.50948         0 0.9115580

Normalcy
mean_norm median_norm var_norm kurtosis      p.value  skewness p.value.1  cv_norm
EFFR  24.79907           9 636.0882        1 2.104439e-09 -13.10732         0 1.017006
OBFR  20.79439           9 453.4080        1 2.104439e-09 -13.10732         0 1.023996
TGCR  20.96028           8 455.3481        1 2.104439e-09 -13.10732         0 1.018063
BGCR  21.88318           7 528.7372        1 2.104439e-09 -13.10732         0 1.050775
SOFR  24.27336           8 615.5837        1 2.104439e-09 -13.10732         0 1.022147

Adjust
mean_adjust median_adjust var_adjust kurtosis    p.value  skewness    p.value.1 cv_adjust
EFFR    199.2031         212.0   269.6565        1 0.09035933 -3.664153 1.870095e-34 0.1266084
OBFR    196.9688         210.0   261.2371        1 0.09035933 -3.664153 1.870095e-34 0.1081054
TGCR    205.2969         207.0  1981.5771        1 0.09035933 -3.664153 1.870095e-34 0.1039416
BGCR    205.3438         207.0  1980.1339        1 0.09035933 -3.664153 1.870095e-34 0.1119795
SOFR    207.2656         209.5  1940.3251        1 0.09035933 -3.664153 1.870095e-34 0.1197061

Covid
 stats_covid
     mean_covid median_covid var_covid kurtosis    p.value  skewness    p.value.1  cv_covid
EFFR   125.9817          155  3152.296        1 0.02936657 -4.734451 5.599941e-93 0.4456626
OBFR   125.0917          154  3212.714        1 0.02936657 -4.734451 5.599941e-93 0.4531139
TGCR   123.4404          152  3310.045        1 0.02936657 -4.734451 5.599941e-93 0.4660792
BGCR   123.4679          152  3303.381        1 0.02936657 -4.734451 5.599941e-93 0.4655060
SOFR   125.6330          155  3404.086        1 0.02936657 -4.734451 5.599941e-93 0.4644045

ZLB
     mean_zlb median_zlb  var_zlb kurtosis      p.value  skewness p.value.1    cv_zlb
EFFR 6.464876          7 6.849695        1 6.368494e-06 -9.869312         0 0.4048326
OBFR 5.925620          5 8.081413        1 6.368494e-06 -9.869312         0 0.4797443
TGCR 6.136364          7 5.981366        1 6.368494e-06 -9.869312         0 0.3985558
BGCR 5.064050          5 4.888229        1 6.368494e-06 -9.869312         0 0.4365940
SOFR 6.371901          7 4.735109        1 6.368494e-06 -9.869312         0 0.3415042

Inflation
     mean_inflation median_inflation var_inflation kurtosis    p.value  skewness     p.value.1 cv_inflation
EFFR       207.9442              233      16651.18        1 0.00372241 -6.325206 5.819888e-292    0.6205485
OBFR       207.4365              232      16855.78        1 0.00372241 -6.325206 5.819888e-292    0.6258772
TGCR       202.2589              226      16093.69        1 0.00372241 -6.325206 5.819888e-292    0.6272205
BGCR       202.1980              226      16142.15        1 0.00372241 -6.325206 5.819888e-292    0.6283533
SOFR       203.4365              227      16656.67        1 0.00372241 -6.325206 5.819888e-292    0.6344027
