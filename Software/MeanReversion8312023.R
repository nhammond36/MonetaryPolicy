...
# for (t in 1:T) {
#     for (i in 1:K) {}
#     vtot[t,1]=  vtot[t,1]+ vold[t,i]; % volume at t   ?? zt
#     mrate[t,1] = mrate[t,1]+ vold[t,i]*rrbp[t,i]; 
#     }
#
#     % for now, the on equiv rate is the rate in data
#     meanr[t,1] =mrate[t,1]/vtot[t,1];
# 
#     for (i=1:5 ) { 
#      d[t,1] = d[t,1]+(vold[t,i]*(abs(rrbp[t,i]- meanr[t,1]));
#     }
#     d[t,1] <-d[t,1]/vtot[t,1]
#     
# }
