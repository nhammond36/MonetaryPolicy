...
spread_no_na <- spread_no_na %>%
  mutate_at(vars(-sdate), ~ ifelse(is.numeric(.), .*100, .))
...
quantileseffr <- ggplot(quantilesE, aes(x = sdate)) +
  ...
  geom_line(aes(y = TargetUe, linetype = "Upper target"), color = "black", linewidth = 1) +
  ...
  labs(x = "Date", y = "basis points (bp)", color = "Legend Title", linetype = "Legend Title") + 
  scale_color_manual(values = c("EFFR" = "black", "Upper target"="black","Lower target"="black","PercentileE1" = "yellow", "PercentileE25"= "green","PercentileE75" = "blue","PercentileE99" = "red"), name = "Legend Title") + 
  scale_linetype_manual(values = c("EFFR" = "solid", "Upper target" = "dashed", "Lower target" = "dotted", "PercentileE1" = "dotdash", "PercentileE25" = "dotdash", "PercentileE75" = "dotdash", "PercentileE99" = "dotdash"), name = "Legend Title") +  
  #scale_color_manual(values = c("black", "black", "black", "yellow", "green", "blue", "red"), 
  #                   name = "Legend Title", labels = c("EFFR", "Upper target", "Lower target", "PercentileE1", "PercentileE25", "PercentileE75", "Percentile99")) + 
  #scale_linetype_manual(values = c("solid", "dashed", "dotted", "dotdash", "dotdash", "dotdash", "dotdash"), 
  #                      name = "Legend Title", labels = c("EFFR", "Upper target", "Lower target", "PercentileE1", "PercentileE25", "PercentileE75", "Percentile99")) +  
  scale_y_continuous(breaks = y_breaks, limits = y_limits) +
  theme_minimal()
...
# quantileseffr <- ggplot(quantilesE, aes(x = sdate)) +
#   geom_line(aes(y = EFFR, color = "EFFR",linetype = "EFFR",linetype = "EFFR"), linewidth =1) + 
#   geom_line(aes(y = TargetUe, color = "Upper target",linetype = "Upper target"), linewidth = 1) +
#   geom_line(aes(y = TargetDe, color = "Lower target",linetype = "Lower target"), linewidth = 1) +
#   geom_line(aes(y = PercentileE1, color = "PercentileE1",linetype = "PercentileE1"), linewidth = 1) + 
#   geom_line(aes(y = PercentileE25, color = "PercentileE25",linetype = "PercentileE25"), linewidth = 1) + 
#   geom_line(aes(y = PercentileE75, color = "PercentileE75",linetype = "PercentileE75"), linewidth = 1) + 
#   geom_line(aes(y = PercentileE99, color = "PercentileE99",linetype = "Percentile99"), linewidth = 1) + 
#   labs(x = "Date", y = "basis points (bp)", color = "Legend Title", linetype = "Legend Title") + 
#   scale_color_manual(values = c("EFFR" = "black", "Upper target"="black","Lower target"="black","PercentileE1" = "yellow", "PercentileE25"= "green","PercentileE75" = "blue","PercentileE99" = "red"), name = "Legend Title") + 
#   scale_linetype_manual(values = c("EFFR" = "solid", "Upper target" = "dashed", "Lower target" = "dotted", "PercentileE1" = "dotdash", "PercentileE25" = "dotdash", "PercentileE75" = "dotdash", "PercentileE99" = "dotdash"), name = "Legend Title") +  
#   scale_y_continuous(breaks = y_breaks, limits = y_limits)+
#   theme_minimal() 
# COmpare to find error
# labs(x = "Date", y = "basis points (bp)", color = "Legend Title", linetype = "Legend Title") + 
#   scale_color_manual(values = c("EFFR" = "black", "OBFR" = "blue", "TGCR" = "green", "BGCR" = "cyan", "SOFR" = "red"), name = "Legend Title") + 
#   scale_linetype_manual(values = c("EFFR" = "solid", "OBFR" = "dashed", "TGCR" = "dotted", "BGCR" = "dotdash", "SOFR" = "longdash"), name = "Legend Title") +  
print(quantileseffr) 
