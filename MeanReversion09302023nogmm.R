...
quantilesE<- data.frame(selected_quantilesE)*100
head(quantilesE)
#quantilesO<- data.frame(selected_quantilesO)*100
#head(quantilesO)
quantilesT<- data.frame(selected_quantilesT)*100
head(quantilesT)
quantilesB<- data.frame(selected_quantilesB)*100
head(quantilesB)
quantilesS<- data.frame(selected_quantilesS)*100
head(quantilesS)
